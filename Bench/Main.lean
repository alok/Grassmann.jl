...
def suites : List Suite :=
  [ Bench.Math.suite, Bench.JuliaBase.suite, Bench.StaticVectors.suite, Bench.DirectSum.suite, Bench.UnitSystems.suite, Bench.Dendriform.suite, Bench.DeMorgan.suite, Bench.Wilkinson.suite, Bench.Geophysics.suite, Bench.MeshTopology.suite, Bench.Fatou.suite ] ++
